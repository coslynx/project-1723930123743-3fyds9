...
const SocialFeed: React.FC = () => {
  ...
  if (isError) {
    return <div className="text-center text-fittrack-error">Error: {error instanceof Error ? error.message : 'An error occurred'}</div>;
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      {session && (
        <form onSubmit={handleSubmit(onSubmit)} className="mb-8">
          ...
          <button
            type="submit"
            className="bg-fittrack-primary text-white px-4 py-2 rounded-md hover:bg-opacity-90 transition-colors"
          ...
          <div key={post.id} className="bg-white shadow-md rounded-lg p-6">
            ...
            <div className="flex items-center justify-between">
              <button
                ...
                className="flex items-center text-fittrack-secondary hover:text-fittrack-primary transition-colors"
